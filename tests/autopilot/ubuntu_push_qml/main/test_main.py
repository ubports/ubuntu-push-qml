...
import os
from ubuntu_push_qml import UbuntuTouchAppTestCase


class MainTests(UbuntuTouchAppTestCase):
    """Generic tests for the Hello World"""

    test_qml_file = "%s/%s" % (os.path.dirname(os.path.realpath(__file__)),"../../../../../share/ubuntu-push-example/ubuntu-push-example.qml")
